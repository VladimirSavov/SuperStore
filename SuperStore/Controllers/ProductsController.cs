namespace SuperStore.Controllers
{
    ...
    public class ProductsController:Controller
    {
        ...
        public ProductsController(SuperStoreDbContext data, IProductsService products, ITraderService traders, IMapper mapper, IReviewService reviews, IQuestionsService questions)
        {
            this.data = data;
