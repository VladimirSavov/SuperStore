...
{
    using SuperStore.Data.Configuration;
    using SuperStore.Data.Models;
    using Microsoft.AspNetCore.Identity.EntityFrameworkCore;
    using Microsoft.EntityFrameworkCore;

    public class SuperStoreDbContext : IdentityDbContext<User>
    {
        public SuperStoreDbContext(DbContextOptions<SuperStoreDbContext> options)
            : base(options)
        {
        }
